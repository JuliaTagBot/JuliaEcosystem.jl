...
module JuliaEcosystem
    ...
    """
        PkgMetaData(pkg::AbstractString)
    ...
    struct PkgMetaData
        ...
        installable::Bool
        function PkgMetaData(pkg::AbstractString)
            ...
            try
                ...
                new(name, uuid, repo, version, dependencies, true)
            catch
                new(name, uuid, repo, VersionNumber(0), Vector{String}(), false)
            end
        end
    end
